...
const PATTERNS = [
  ...
  { re: /\bteam\s+\d+/, skill: "claude-forge:team" },
  { re: /\breview[- ]?team\b/, skill: "claude-forge:team" },
  { re: /\bbuild[- ]?team\b/, skill: "claude-forge:team" },
  { re: /\bfullstack[- ]?team\b/, skill: "claude-forge:team" },
  { re: /\baudit[- ]?team\b/, skill: "claude-forge:team" },
  { re: /\bdebug[- ]?team\b/, skill: "claude-forge:team" },
  { re: /\bswarm\b/, skill: "claude-forge:swarm" },
  { re: /\bfire\s+and\s+forget\b/, skill: "claude-forge:swarm" },
  { re: /\bspawn\s+\d+\s+agents\b/, skill: "claude-forge:swarm" },
